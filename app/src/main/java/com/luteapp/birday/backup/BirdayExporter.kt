package com.luteapp.birday.backup
...
class BirdayExporter(context: Context?, attrs: AttributeSet?) : Preference(context, attrs),
    ...
    // Export the room database to a file in Android/data/com.luteapp.birday/files
    ...
    private fun shareBackup(fileUri: String) {
        ...
        val contentUri: Uri = getUriForFile(context, "com.luteapp.birday.fileprovider", file)
